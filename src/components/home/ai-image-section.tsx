...
export function AiImageSection() {
  return (
    <section id="ai-image" className="relative overflow-hidden bg-[#07111f] py-14 text-white">
      ...
      <div className="relative mx-auto grid w-[min(1500px,calc(100vw-28px))] gap-8 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-center">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link
              href="/ai-image"
              className="inline-flex h-11 items-center gap-2 rounded-full bg-cyan-400 px-6 text-sm font-black text-slate-950 shadow-lg shadow-cyan-400/20 transition hover:-translate-y-0.5 hover:bg-cyan-300"
            >
              开始生图
            ...
            <Link
              ...
              className="inline-flex h-11 items-center gap-2 rounded-full bg-white/10 px-5 text-sm font-bold text-white ring-1 ring-white/15 transition hover:bg-white/15"
            >
              查看 MAX 模型
            </Link>
          </div>
        ...
        <div className="rounded-[28px] border border-white/12 bg-white/10 p-4 shadow-2xl shadow-cyan-950/50 backdrop-blur">
          <div className="rounded-2xl bg-slate-950/80 p-5 ring-1 ring-white/10">
