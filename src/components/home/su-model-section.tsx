...
export function SuModelSection() {
  return (
    <section id="su-models" className="scroll-mt-28 bg-white/45 py-12 backdrop-blur-sm">
      <div className="mx-auto w-[min(1760px,calc(100vw-32px))]">
        {/* 标题栏 */}
        <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div className="flex items-start gap-4">
            <span className="grid h-12 w-12 shrink-0 place-items-center rounded-md bg-gradient-to-br from-amber-100 to-white text-amber-700 shadow-sm ring-1 ring-amber-200/50">
